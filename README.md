...
1. MainActivity
   ...
   - 随礼界面、主界面、收礼界面如下显示。
     ...
     ![image-20211001093058146](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001093058146.png)
...
2. StartActivity
   ...
   ![image-20210715233537166](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20210715233537166.png)
...
3. UpdateActivity
   ...
   - 随礼的UpdateActivity如下图所示，有名字、金额、日期。
     ...
     ![image-20210715233735475](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20210715233735475.png)

   - 收礼的UpdateActivity如下图所示，有名字、金额、日期和一个缘由。

     ![image-20210715233742630](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20210715233742630.png)
...
![image-20211001094552401](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001094552401.png)

点击浏览收礼、随礼界面

![image-20211001094607886](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001094607886.png)

 回到主界面，点击右下角按钮，选择收礼，输入信息，选着日期，选择缘由，确定

![image-20211001094626078](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001094626078.png)

查看收礼信息，长按刚刚新增的记录，选择修改

<img src="C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001094701879.png" alt="image-20211001094701879"  />

修改信息，点击确定

![image-20211001094804869](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001094804869.png)

长按刚刚修改的记录，选择追加，输入信息，点击确定

![image-20211001094834035](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001094834035.png)

长按刚刚追加的记录，选择删除

![image-20211001094852751](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001094852751.png)
...
![image-20211001095546392](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001095546392.png)
...
![image-20211001095803346](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001095803346.png)
...
![image-20211001095820494](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001095820494.png)

###### 4.启动界面效果图

已经实现默认启动页的显示及全屏显示背景图片。目前还需要改进的地方是把那个导航栏去除

![image-20211001095908633](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001095908633.png)
...
![image-20211001095934744](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001095934744.png)
...
![image-20211001100042757](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100042757.png)

后来发现下列这一段注释掉也没事

![image-20211001100053347](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100053347.png)

6.现在再看看效果，如下图，已经可以显示启动页了
既实现了全屏，也实现了导航栏隐藏。

![image-20211001100104392](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100104392.png)
...
![image-20211001100142117](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100142117.png)

8.运行程序，成功实现界面跳转。

![image-20211001100154213](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100154213.png)
...
![image-20211001100219984](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100219984.png)
...
![image-20211001100238842](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100238842.png)

③新建三个Fragment对象，分别用来实现主界面、收礼记录界面、随礼记录界面三个界面。

![image-20211001100258326](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100258326.png)
...
![image-20211001100323736](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100323736.png)
...
2. 利用安卓自带的日历控件，先配置好布局文件，如下图所示
   ...
   ![image-20211001100607012](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100607012.png)
...
3. 在主activity中添加日历的事件监听函数
   ...
   ![image-20211001100635599](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100635599.png)

- 利用FloatingActionButton+Intent+onActivityResult实现添加信息的功能。
  用fab菜单实现两个fab按钮，这两个按钮分别负责添加随礼、收礼记录的功能，用户按需选择任意一个按钮。布局如下图

  ![image-20211001100955546](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100955546.png)
  ...
  **关键技术主要是按钮的监听函数需要实现两个activity的数据传递：**
  ...
  4. A在onActivityResult中接收B传回的数据，更新界面
     ...
     ![image-20211001100933491](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001100933491.png)

     按钮的效果如下

![image-20211001101018075](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101018075.png)
...
![image-20211001101115223](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101115223.png)

然后在fragment中初始化

![image-20211001101125302](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101125302.png)

到此为止，我们的数据处理就结束了。
②布局处理：
因为ListView列表中有很多子项目，因此若我们要显示数据，就要把数据绑定到子项目对应的控件上去。这时我们需要有一个描述该控件的布局的布局文件，子项目显示人名、金额、日期

![image-20211001101430860](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101430860.png)
...
![image-20211001101455017](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101455017.png)

完成了适配器的创建以后，我必须要安装上这个适配器才能使其发挥作用。
④安装适配器
安装适配器的意思就是说，把适配器设置到ListView控件上，使的这个ListView能在适配器的作用下，显示子项目。安装适配器的代码如下。

![image-20211001101513333](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101513333.png)
...
![image-20211001101541510](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101541510.png) onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo)：在创建菜单时调用，可以获得创建菜单时的视图以及所点击的项目等参数，可为不同视图创建不同菜单。
...
![image-20211001101602568](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101602568.png)
...
![image-20211001101619468](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101619468.png)
...
![image-20211001101640492](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001101640492.png)
...
4. 将点击该fragment后想加载的数据和view的逻辑（代码）放到Fragment的onResume()方法中即可
   ...
   ![image-20211001102051970](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001102051970.png)
...
![image-20211001102256275](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001102256275.png)

通过按钮触发日期选择器

![image-20211001102338045](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001102338045.png)

实现选择器的监听，并将获取到的结果设置到TextView上

![image-20211001102352932](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001102352932.png)

下图是日期选择器效果图

![image-20211001102410647](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20211001102410647.png)
